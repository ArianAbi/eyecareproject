...
export default function AdminEditProductForm({
  ...
  const { control, handleSubmit, formState, setValue } = useForm<formType>({
    ...
    defaultValues: {
      ...
      price: product.price,
      type: product.type,
      includesGuarantee: product.includesGuarantee,
  ...
  const onSubmit = handleSubmit(async (values) => {
    try {
      await ADMIN_UpdateProduct(id, {
        ...
        lens: values.lens,
        tagIds: values.tags,
        includesGuarantee: values.includesGuarantee,
    ...
    <form onSubmit={onSubmit} className="grid grid-cols-2 gap-2">
      ...
      <div>
        ...
        {price > 0 && (
          <div className="flex gap-1 mt-2 text-sm">
            ...
            <div className="text-emerald-500 font-semibold">تومان</div>
          </div>
        )}
      </div>
      ...
      <div className="col-span-2 gap-2 my-2 grid grid-cols-2 border-2 p-2 rounded-lg">
        ...
        <div className="border p-2 rounded-md gap-2 grid grid-cols-2 col-span-2">
          <div className="my-2 font-semibold col-span-full gap-2">Sphere</div>
          ...
          <div className="my-2 font-semibold col-span-full gap-2">Cylinder</div>
      ...
      <div className="col-span-full flex justify-around my-2 border py-3 rounded-lg">
        ...
        <div className="grid grid-cols-2 center gap-1">
          <Checkbox
            checked={formValues.includesGuarantee}
            onCheckedChange={(value) =>
              setValue("includesGuarantee", value, {
                shouldDirty: true,
                shouldValidate: true,
              })
            }
          ...
          <div
            className={
              formValues.includesGuarantee ? "stroke-white" : "stroke-gray-400"
            }
          >
            <Shield stroke="inherit" size={26} />
          </div>

          <div
            className={`col-span-2 ${formValues.includesGuarantee ? "text-white" : "text-gray-400"}`}
          >
            گارانتی
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 center gap-1">
          ...
          <div
            className={
              formValues.includesBag ? "stroke-white" : "stroke-gray-400"
            }
          >
          ...
          <div
            className={`col-span-2 ${formValues.includesBag ? "text-white" : "text-gray-400"}`}
          >
            ساکدستی
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 center gap-1">
          ...
          <div
            className={
              formValues.includesSpray ? "stroke-white" : "stroke-gray-400"
            }
          >
          ...
          <div
            className={`col-span-2 ${formValues.includesSpray ? "text-white" : "text-gray-400"}`}
          >
            اسپری
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 center gap-1">
          ...
          <div
            className={
              formValues.includesCloth ? "stroke-white" : "stroke-gray-400"
            }
          >
          ...
          <div
            className={`col-span-2 ${formValues.includesCloth ? "text-white" : "text-gray-400"}`}
          >
            دستمال
          </div>
        </div>
