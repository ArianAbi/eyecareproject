        ...
        <div className="mx-auto max-w-6xl space-y-12 px-5 py-10 md:py-16">
          ...
          <section className="grid items-center gap-8 md:grid-cols-[1.5fr_1fr]">
            <div className="space-y-6">
              <Badge variant="outline">
                ویژه فروشگاه‌های عینک و همکاران اپتیک
              </Badge>
              <h1
                id="video-trigger"
                className="text-3xl font-bold leading-relaxed md:text-4xl"
              >
              ...
              <p className="max-w-xl text-base leading-8 text-muted-foreground">
                ...
                کنید، مراحل آماده‌سازی و ارسال را دنبال کنید و امور مالی فروشگاه
                را از یک پنل مدیریت کنید.
              </p>
          ...
          <section className="rounded-xl border p-6 md:p-8">
            ...
            <p className="max-w-3xl text-sm leading-8 text-muted-foreground">
              این سامانه برای تامین عدسی مورد نیاز کسب‌وکارهای اپتیک طراحی شده
              است. برای شروع همکاری حساب بسازید و پرسش‌های خود درباره سفارش و
              شرایط همکاری را از بخش پشتیبانی پیگیری کنید.
            </p>
          </section>
